...
use Mage\Import\Api\Data\DataInterfaceFactory;
use Mage\Import\Api\Data\DataSearchResultsInterfaceFactory;
use Mage\Import\Model\ResourceModel\Data as ResourceData;
use Mage\Import\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \Mage\Import\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \Mage\Import\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Mage\Import\Model\ResourceModel\Data\Collection $collection */
